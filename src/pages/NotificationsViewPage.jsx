...
//       NewServicePostNotification: { icon: <Megaphone size={20} />, color: '#3b82f6', bg: 'rgba(59,130,246,0.1)' },
//       NewPostResponseNotification: { icon: <MessageCircle size={20} />, color: '#ec4899', bg: 'rgba(236,72,153,0.1)' },
//       PostResponseAcceptedNotification: { icon: <CheckCircle size={20} />, color: '#059669', bg: 'rgba(5,150,105,0.1)' },
//       NewMessageNotification: { icon: <MessageCircle size={20} />, color: '#6366f1', bg: 'rgba(99,102,241,0.1)' },
//     };
//     return styles[type] || { icon: <Bell size={20} />, color: '#94a3b8', bg: 'rgba(148,163,184,0.1)' };
//   };
...
//                     {/* بطاقة بيانات العميل — تظهر فقط لو الإشعار قبول عرض وفيه phone */}
//                     {notif.type === 'PostResponseAcceptedNotification' && notif.data?.client_phone && (
//                       <div style={{
//                         marginTop: '10px',
//                         padding: '10px 14px',
//                         borderRadius: '10px',
//                         background: darkMode ? 'rgba(5,150,105,0.12)' : 'rgba(5,150,105,0.08)',
//                         border: '1px solid rgba(5,150,105,0.25)',
//                         display: 'flex', flexDirection: 'column', gap: '4px',
//                       }}>
//                         <span style={{ fontSize: '0.78rem', fontWeight: 700, color: '#059669' }}>
//                           📋 {lang === 'ar' ? 'بيانات العميل للتواصل' : 'Client Contact Info'}
//                         </span>
//                         {notif.data?.client_name && (
//                           <span style={{ fontSize: '0.82rem', color: textColor }}>
//                             👤 {notif.data.client_name}
//                           </span>
//                         )}
//                         <a
//                           href={`tel:${notif.data.client_phone}`}
...
const NotificationsViewPage = () => {
  ...
  const getNotificationStyle = (type) => {
    const styles = {
      ...
      NewPostResponseNotification: { icon: <MessageCircle size={20} />, color: '#ec4899', bg: 'rgba(236,72,153,0.1)' },
      PostResponseAcceptedNotification: { icon: <CheckCircle size={20} />, color: '#059669', bg: 'rgba(5,150,105,0.1)' },
      offer_accepted: { icon: <CheckCircle size={20} />, color: '#059669', bg: 'rgba(5,150,105,0.1)' },
      NewMessageNotification: { icon: <MessageCircle size={20} />, color: '#6366f1', bg: 'rgba(99,102,241,0.1)' },
    };
    return styles[type] || { icon: <Bell size={20} />, color: '#94a3b8', bg: 'rgba(148,163,184,0.1)' };
  };
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    {/* بطاقة بيانات العميل — تظهر فقط لو الإشعار قبول عرض وفيه phone */}
                    {(notif.type === 'PostResponseAcceptedNotification' || notif.type === 'offer_accepted') && notif.data?.client_phone && (
                      <div style={{
                        marginTop: '10px',
                        padding: '10px 14px',
                        borderRadius: '10px',
