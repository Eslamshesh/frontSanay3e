...
//           {/* ✅ التقييمات - للعميل فقط */}
//           {isCustomer && <Link to="/reviews" style={navLinkStyle(isActive('/reviews'), darkMode)}><Star size={14} style={{ display: 'inline', marginLeft: '4px' }} />{t.reviews}</Link>}
...
//           {/* ✅ حجوزاتي للحرفي */}
//           {isCraftsman && (
//             <Link to="/craftsman/bookings" style={navLinkStyle(isActive('/craftsman/bookings'), darkMode)}>
//               <Calendar size={14} style={{ display: 'inline', marginLeft: '4px' }} />
//               {t.myBookings}
//             </Link>
//           )}
...
//           {/* ✅ تقييماتي للحرفي */}
//           {isCraftsman && (
//             <Link to="/craftsman/reviews" style={navLinkStyle(isActive('/craftsman/reviews'), darkMode)}>
...
const Header = () => {
  ...
  const t = {
    ...
    myPosts: lang === 'ar' ? 'منشوراتي' : 'My Posts',
    servicePosts: lang === 'ar' ? 'طلبات الخدمة' : 'Service Requests',
    myReviews: lang === 'ar' ? 'تقييماتي' : 'My Reviews',
  };
